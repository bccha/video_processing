	component soc_system is
		port (
			...
			rx_dma_read_data                      : out   std_logic_vector(7 downto 0);                     -- data
			rx_dma_read_valid                     : out   std_logic;                                        -- valid
			rx_dma_read_ready                     : in    std_logic                     := 'X';             -- ready
			rx_dma_read_startofpacket             : out   std_logic;                                        -- startofpacket
			rx_dma_read_endofpacket               : out   std_logic;                                        -- endofpacket
			rx_dma_write_data                     : in    std_logic_vector(31 downto 0) := (others => 'X'); -- data
			rx_dma_write_valid                    : in    std_logic                     := 'X';             -- valid
			rx_dma_write_ready                    : out   std_logic;                                        -- ready
			rx_dma_write_startofpacket            : in    std_logic                     := 'X';             -- startofpacket
			rx_dma_write_endofpacket              : in    std_logic                     := 'X';             -- endofpacket
			rx_dma_write_empty                    : in    std_logic_vector(1 downto 0)  := (others => 'X'); -- empty
	...
	u0 : component soc_system
		port map (
			...
			rx_dma_read_data                      => CONNECTED_TO_rx_dma_read_data,                      --                    rx_dma_read.data
			rx_dma_read_valid                     => CONNECTED_TO_rx_dma_read_valid,                     --                               .valid
			rx_dma_read_ready                     => CONNECTED_TO_rx_dma_read_ready,                     --                               .ready
			rx_dma_read_startofpacket             => CONNECTED_TO_rx_dma_read_startofpacket,             --                               .startofpacket
			rx_dma_read_endofpacket               => CONNECTED_TO_rx_dma_read_endofpacket,               --                               .endofpacket
			rx_dma_write_data                     => CONNECTED_TO_rx_dma_write_data,                     --                   rx_dma_write.data
			rx_dma_write_valid                    => CONNECTED_TO_rx_dma_write_valid,                    --                               .valid
			rx_dma_write_ready                    => CONNECTED_TO_rx_dma_write_ready,                    --                               .ready
			rx_dma_write_startofpacket            => CONNECTED_TO_rx_dma_write_startofpacket,            --                               .startofpacket
			rx_dma_write_endofpacket              => CONNECTED_TO_rx_dma_write_endofpacket,              --                               .endofpacket
			rx_dma_write_empty                    => CONNECTED_TO_rx_dma_write_empty,                    --                               .empty
