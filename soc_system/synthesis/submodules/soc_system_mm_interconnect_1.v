...
module soc_system_mm_interconnect_1 (
		...
		input  wire [31:0] video_dma_m0_address,                                               //                                                 video_dma_m0.address
		output wire        video_dma_m0_waitrequest,                                           //                                                             .waitrequest
		input  wire [8:0]  video_dma_m0_burstcount,                                            //                                                             .burstcount
		input  wire [3:0]  video_dma_m0_byteenable,                                            //                                                             .byteenable
		input  wire        video_dma_m0_read,                                                  //                                                             .read
		output wire [31:0] video_dma_m0_readdata,                                              //                                                             .readdata
		output wire        video_dma_m0_readdatavalid,                                         //                                                             .readdatavalid
		input  wire        video_dma_m0_write,                                                 //                                                             .write
		input  wire [31:0] video_dma_m0_writedata,                                             //                                                             .writedata
		input  wire        video_dma_m0_debugaccess,                                           //                                                             .debugaccess
	...
	wire  [109:0] rsp_mux_src_data;                                                                           // rsp_mux:src_data -> address_span_extender_0_expanded_master_agent:rp_data
	...
	wire          video_dma_m0_translator_avalon_universal_master_0_waitrequest;                              // video_dma_m0_agent:av_waitrequest -> video_dma_m0_translator:uav_waitrequest
	wire   [31:0] video_dma_m0_translator_avalon_universal_master_0_readdata;                                 // video_dma_m0_agent:av_readdata -> video_dma_m0_translator:uav_readdata
	wire          video_dma_m0_translator_avalon_universal_master_0_debugaccess;                              // video_dma_m0_translator:uav_debugaccess -> video_dma_m0_agent:av_debugaccess
	wire   [31:0] video_dma_m0_translator_avalon_universal_master_0_address;                                  // video_dma_m0_translator:uav_address -> video_dma_m0_agent:av_address
	wire          video_dma_m0_translator_avalon_universal_master_0_read;                                     // video_dma_m0_translator:uav_read -> video_dma_m0_agent:av_read
	wire    [3:0] video_dma_m0_translator_avalon_universal_master_0_byteenable;                               // video_dma_m0_translator:uav_byteenable -> video_dma_m0_agent:av_byteenable
	wire          video_dma_m0_translator_avalon_universal_master_0_readdatavalid;                            // video_dma_m0_agent:av_readdatavalid -> video_dma_m0_translator:uav_readdatavalid
	wire          video_dma_m0_translator_avalon_universal_master_0_lock;                                     // video_dma_m0_translator:uav_lock -> video_dma_m0_agent:av_lock
	wire          video_dma_m0_translator_avalon_universal_master_0_write;                                    // video_dma_m0_translator:uav_write -> video_dma_m0_agent:av_write
	wire   [31:0] video_dma_m0_translator_avalon_universal_master_0_writedata;                                // video_dma_m0_translator:uav_writedata -> video_dma_m0_agent:av_writedata
	wire   [10:0] video_dma_m0_translator_avalon_universal_master_0_burstcount;                               // video_dma_m0_translator:uav_burstcount -> video_dma_m0_agent:av_burstcount
	wire          rsp_mux_001_src_valid;                                                                      // rsp_mux_001:src_valid -> video_dma_m0_agent:rp_valid
	wire  [109:0] rsp_mux_001_src_data;                                                                       // rsp_mux_001:src_data -> video_dma_m0_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                                      // video_dma_m0_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                                    // rsp_mux_001:src_channel -> video_dma_m0_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                                              // rsp_mux_001:src_startofpacket -> video_dma_m0_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                                // rsp_mux_001:src_endofpacket -> video_dma_m0_agent:rp_endofpacket
	...
	wire  [110:0] hps_0_f2h_sdram0_data_agent_rf_source_data;                                                 // hps_0_f2h_sdram0_data_agent:rf_source_data -> hps_0_f2h_sdram0_data_agent_rsp_fifo:in_data
	...
	wire  [110:0] hps_0_f2h_sdram0_data_agent_rsp_fifo_out_data;                                              // hps_0_f2h_sdram0_data_agent_rsp_fifo:out_data -> hps_0_f2h_sdram0_data_agent:rf_sink_data
	...
	wire  [109:0] address_span_extender_0_expanded_master_agent_cp_data;                                      // address_span_extender_0_expanded_master_agent:cp_data -> router:sink_data
	...
	wire          video_dma_m0_agent_cp_valid;                                                                // video_dma_m0_agent:cp_valid -> router_001:sink_valid
	wire  [109:0] video_dma_m0_agent_cp_data;                                                                 // video_dma_m0_agent:cp_data -> router_001:sink_data
	wire          video_dma_m0_agent_cp_ready;                                                                // router_001:sink_ready -> video_dma_m0_agent:cp_ready
	wire          video_dma_m0_agent_cp_startofpacket;                                                        // video_dma_m0_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          video_dma_m0_agent_cp_endofpacket;                                                          // video_dma_m0_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [109:0] hps_0_f2h_sdram0_data_agent_rp_data;                                                        // hps_0_f2h_sdram0_data_agent:rp_data -> router_002:sink_data
	...
	wire  [109:0] cmd_mux_src_data;                                                                           // cmd_mux:src_data -> hps_0_f2h_sdram0_data_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                                          // hps_0_f2h_sdram0_data_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                                        // cmd_mux:src_channel -> hps_0_f2h_sdram0_data_burst_adapter:sink0_channel
	...
	wire  [109:0] hps_0_f2h_sdram0_data_burst_adapter_source0_data;                                           // hps_0_f2h_sdram0_data_burst_adapter:source0_data -> hps_0_f2h_sdram0_data_agent:cp_data
	...
	wire    [1:0] hps_0_f2h_sdram0_data_burst_adapter_source0_channel;                                        // hps_0_f2h_sdram0_data_burst_adapter:source0_channel -> hps_0_f2h_sdram0_data_agent:cp_channel
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) video_dma_m0_translator (
		.clk                    (clk_0_clk_clk),                                                   //                       clk.clk
		.reset                  (video_dma_reset_reset_bridge_in_reset_reset),                     //                     reset.reset
		.uav_address            (video_dma_m0_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (video_dma_m0_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (video_dma_m0_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (video_dma_m0_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (video_dma_m0_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (video_dma_m0_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (video_dma_m0_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (video_dma_m0_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (video_dma_m0_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (video_dma_m0_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (video_dma_m0_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (video_dma_m0_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (video_dma_m0_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (video_dma_m0_burstcount),                                         //                          .burstcount
		.av_byteenable          (video_dma_m0_byteenable),                                         //                          .byteenable
		.av_read                (video_dma_m0_read),                                               //                          .read
		.av_readdata            (video_dma_m0_readdata),                                           //                          .readdata
		.av_readdatavalid       (video_dma_m0_readdatavalid),                                      //                          .readdatavalid
		.av_write               (video_dma_m0_write),                                              //                          .write
		.av_writedata           (video_dma_m0_writedata),                                          //                          .writedata
		.av_debugaccess         (video_dma_m0_debugaccess),                                        //                          .debugaccess
		.av_beginbursttransfer  (1'b0),                                                            //               (terminated)
		.av_begintransfer       (1'b0),                                                            //               (terminated)
		.av_chipselect          (1'b0),                                                            //               (terminated)
		.av_lock                (1'b0),                                                            //               (terminated)
	...
	altera_merlin_master_agent #(
		...
		.av_address            (video_dma_m0_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (video_dma_m0_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (video_dma_m0_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (video_dma_m0_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (video_dma_m0_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (video_dma_m0_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (video_dma_m0_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (video_dma_m0_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (video_dma_m0_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (video_dma_m0_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (video_dma_m0_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (video_dma_m0_agent_cp_valid),                                     //        cp.valid
		.cp_data               (video_dma_m0_agent_cp_data),                                      //          .data
		.cp_startofpacket      (video_dma_m0_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (video_dma_m0_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (video_dma_m0_agent_cp_ready),                                     //          .ready
	...
	soc_system_mm_interconnect_1_router router_001 (
		.sink_ready         (video_dma_m0_agent_cp_ready),                 //      sink.ready
		.sink_valid         (video_dma_m0_agent_cp_valid),                 //          .valid
		.sink_data          (video_dma_m0_agent_cp_data),                  //          .data
		.sink_startofpacket (video_dma_m0_agent_cp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (video_dma_m0_agent_cp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (video_dma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
