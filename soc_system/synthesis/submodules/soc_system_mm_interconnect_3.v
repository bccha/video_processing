...
module soc_system_mm_interconnect_3 (
	...
	wire          rsp_mux_src_valid;                                               // rsp_mux:src_valid -> video_dma_m0_agent:rp_valid
	wire  [109:0] rsp_mux_src_data;                                                // rsp_mux:src_data -> video_dma_m0_agent:rp_data
	wire          rsp_mux_src_ready;                                               // video_dma_m0_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                             // rsp_mux:src_channel -> video_dma_m0_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                       // rsp_mux:src_startofpacket -> video_dma_m0_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                         // rsp_mux:src_endofpacket -> video_dma_m0_agent:rp_endofpacket
	...
	wire          video_dma_m0_agent_cp_valid;                                     // video_dma_m0_agent:cp_valid -> router:sink_valid
	wire  [109:0] video_dma_m0_agent_cp_data;                                      // video_dma_m0_agent:cp_data -> router:sink_data
	wire          video_dma_m0_agent_cp_ready;                                     // router:sink_ready -> video_dma_m0_agent:cp_ready
	wire          video_dma_m0_agent_cp_startofpacket;                             // video_dma_m0_agent:cp_startofpacket -> router:sink_startofpacket
	wire          video_dma_m0_agent_cp_endofpacket;                               // video_dma_m0_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [109:0] hps_0_f2h_sdram0_data_agent_rp_data;                             // hps_0_f2h_sdram0_data_agent:rp_data -> router_001:sink_data
