...
(
    ...
    localparam PAD4 = log2ceil(64'h20220 - 64'h20200); 
    localparam PAD5 = log2ceil(64'h20280 - 64'h20240); 
    localparam PAD6 = log2ceil(64'h30020 - 64'h30000); 
    localparam PAD7 = log2ceil(64'h30040 - 64'h30020); 
    // -------------------------------------------------------
    ...
    // ( 0x20200 .. 0x20220 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 18'h20200   ) begin
            src_channel = 17'b00000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x20240 .. 0x20280 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 18'h20240   ) begin
    ...
    // ( 0x30020 .. 0x30040 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 18'h30020   ) begin
